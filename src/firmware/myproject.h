...
// };
// template<>
// struct sycl::is_device_copyable<input_data> : std::true_type {};
...
// };
// template<>
// struct sycl::is_device_copyable<output_data> : std::true_type {};
...
struct MyProject {
    SYCL_EXTERNAL streaming_pipelined_interface void operator()() const;
